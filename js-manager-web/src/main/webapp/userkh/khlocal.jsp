			...
			<div class="view-product">
				<div class="manage account-manage">
					...
					<dl class="account-basic clearfix">
						...
						<p class="text-small">
							<span class="show fl base-name">用户姓名</span>: 石婷<!-- <span class="margin-left"> <em id="ppdname" name = "ppdname"></em> </span> -->
						</p>
						<p class="text-small">
						...
						<p class="text-small">
							<span class="show fl base-name">工&nbsp;&nbsp;号</span>:  20170718-8<%-- <span class="margin-left">${cookie.userid.value}</span> --%>
						</p>
						</dd>
					</dl>
