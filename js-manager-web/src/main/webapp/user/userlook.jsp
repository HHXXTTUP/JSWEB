...
<html>
	...
	<style type="text/css">
        .view-product2 { width: auto; position: absolute; top: 0px; left: 100px; bottom: 0px; right: 0px;padding-bottom:50px;overflow: auto; background: #FFF; }
    </style>
	<body>
		<div class="view-product2">
				...
				<div class="manage account-manage">
					...
					<dl class="account-basic clearfix">
						...
						<p class="text-small">
							<span class="show fl base-name">会员账号</span>:<span class="margin-left">${currentUser.realName } </span>
						</p>
						<p class="text-small">
