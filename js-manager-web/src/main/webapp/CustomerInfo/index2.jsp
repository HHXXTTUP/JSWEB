...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
   		   ...
   		   <li ><a id="s_corp" name="s_corp" title="/S_Corp/S_CorpInfo.jsp" onclick="funcscorp()"><span class="fa fa-caret-right"></span>纱线市场</a></li>
    ...
    <li data-popover="true"  rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 客服总经理导航<span class="label label-info">分配</span></a></li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
           	<li ><a id="kftask" name="kftask" title="/managerInfo/mytask.jsp" onclick="funcmytask()"><span class="fa fa-caret-right"></span>我的任务</a></li>
