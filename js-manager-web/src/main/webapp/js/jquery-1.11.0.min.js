...
(function(w,d,$){
    function layzload(el,callBack){
        ...
        function scrollbox() {
            time=setTimeout(function(){
                $(el).find("img").each(function(){
                    ...
                    if(sh > h + wh || sh < h - wh && _this.getAttribute("data-src") != "done"){
                        clearTimeout(time);
                        return;
                    }
                    if( sh > h-wh && _this.getAttribute("data-src") != "done"){
                        _this.onerror=function(){
                            this.src= "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
                        }
                        _this.src=_this.getAttribute("data-src");
        ...
        if(w.addEventListener){
            w.addEventListener("scroll",function(){scrollbox();},false);
        }else if(w.attachEvent){
            w.attachEvent("onscroll",function(){scrollbox();});
        }
        setTimeout(function(){$(w).trigger("scroll")},20);
    }
